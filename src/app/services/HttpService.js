...
export default class HttpService {
  ...
  _base_telegram_jadaryaBot =
    'https://api.telegram.org/bot988216202:AAHSpqEi_rLpAS9_rdY2_q_GAXXLFvFx__4/sendMessage';
  ...
  async sendMessageToTelegramBot(message) {
    try {
      return await this.request(this._base_telegram_jadaryaBot, 'POST', {
